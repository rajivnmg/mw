...
function outInvExPDF($oinvoice_exciseID,$printType){
	...
	//print_r($buyer[0]->_state_id);exit;
	  ...
	  <tr>
		...
		<div><strong>PAN:</strong> '.$CompanyInfo['PAN'].'</div> 
			  ...
			  <td align="center" style="width:33%;">
		<div><strong> INVOICE No. </strong>'.$outgoing_invoice_excise_h->oinvoice_No.'</div> 
		</td>
	  </tr>
	  <tr>
		<td style="width:33%;">
	...
	State & State Code : '.$billedState[0]->_stateName.' - '.$billedState[0]->_stateCode.'  <br> Contact Name : '.$buyer[0]->_city_name.' <br> Email : '.$buyer[0]->_city_name.'</span> 
						 <br>
	...
	State & State Code : '.$shippedState[0]->_stateName.' - '.$shippedState[0]->_stateCode.'<br> Contact Name : '.$buyer[0]->_city_name.' <br> Email : '.$buyer[0]->_city_name.'</span> 
						 <br>
		...
		<td>: '.$pod_value->pod.'<br></td>
			...
			<div class="invoiceMainTbl">
			  <table style="table-layout:fixed; width:100%; border-collapse: collapse;">
					...
					$FCGST_Rate = 0;
					$FSGST_Rate = 0;
					$FIGST_Rate = $InsIGST_Rate = $pfIGST_Rate = $IncIGST_Rate = 18;
					$otIGST_Rate = 28;
					$FCGST_Amt = 0;
					$FSGST_Amt = 0;
					$FIGST_Amt = 0;
					...
					if($buyer[0]->_state_id == $principal[0]->_state_id) {
						...
						$pfSGST_Amt = $pfCGST_Amt = ($TaxablePF * 9) / 100;
						$otSGST_Amt = $otCGST_Amt = ($TaxableOT * 14) / 100;
						$InsSGST_Amt = $InsCGST_Amt = ($TaxableInsurance * 9) / 100;
						$IncSGST_Amt = $IncCGST_Amt = ($TaxableIncidental * 9) / 100;
						$FSGST_Amt = $FCGST_Amt = ($TaxableFreight * 9) / 100;
						...
						$FIGST_Amt = ($TaxableFreight * 18) / 100;
						$pfIGST_Amt = ($TaxablePF * 18) / 100;
						$otIGST_Amt = ($TaxableOT * 28) / 100;
						$InsIGST_Amt = ($TaxableInsurance * 18) / 100;
						$IncIGST_Amt = ($TaxableIncidental * 18) / 100;
				...
				$html .=	'<tr>
					  ...
					  <td style=" border: 1px solid #aaa;">'.$TaxableInsurance.'</td>
					  <td style=" border: 1px solid #aaa;">'.$InsCGST_Rate.'</td>
					  <td style=" border: 1px solid #aaa;">'.$InsCGST_Amt.'</td>
					  <td style=" border: 1px solid #aaa;">'.$InsSGST_Rate.'</td>
					  <td style=" border: 1px solid #aaa;">'.$InsSGST_Amt.'</td>
					  <td style=" border: 1px solid #aaa;">'.$InsIGST_Rate.'</td>
					  <td style=" border: 1px solid #aaa;">'.$InsIGST_Amt.'</td>
					  <td style=" border: 1px solid #aaa;">'.$TotalInsuranceAmt.'</td>
				  </tr>';
			  }
				...
				$html .=	'<tr>
					  ...
					  <td style=" border: 1px solid #aaa;">'.$TaxableIncidental.'</td>
					  <td style=" border: 1px solid #aaa;">'.$IncCGST_Rate.'</td>
					  <td style=" border: 1px solid #aaa;">'.$IncCGST_Amt.'</td>
					  <td style=" border: 1px solid #aaa;">'.$IncSGST_Rate.'</td>
					  <td style=" border: 1px solid #aaa;">'.$IncSGST_Amt.'</td>
					  <td style=" border: 1px solid #aaa;">'.$IncIGST_Rate.'</td>
					  <td style=" border: 1px solid #aaa;">'.$IncIGST_Amt.'</td>
					  <td style=" border: 1px solid #aaa;">'.$TotalIncidentalAmt.'</td>
				  </tr>';
			  }
			  if(!empty($outgoing_invoice_excise_h->pf_chrg) && $outgoing_invoice_excise_h->pf_chrg > 0) {
					$html .=	'<tr>
					  ...
					  <td style=" border: 1px solid #aaa;">'.$TaxablePF.'</td>
					  <td style=" border: 1px solid #aaa;">'.$pfCGST_Rate.'</td>
					  <td style=" border: 1px solid #aaa;">'.$pfCGST_Amt.'</td>
					  <td style=" border: 1px solid #aaa;">'.$pfSGST_Rate.'</td>
					  <td style=" border: 1px solid #aaa;">'.$pfSGST_Amt.'</td>
					  <td style=" border: 1px solid #aaa;">'.$pfIGST_Rate.'</td>
					  <td style=" border: 1px solid #aaa;">'.$pfIGST_Amt.'</td>
					  <td style=" border: 1px solid #aaa;">'.$TotalPfAmt.'</td>
				  </tr>';
			  }
			  if(!empty($outgoing_invoice_excise_h->othc_charge) && $outgoing_invoice_excise_h->othc_charge > 0) {
					$html .=	'<tr>
					  ...
					  <td style=" border: 1px solid #aaa;">'.$TaxableOT.'</td>
					  <td style=" border: 1px solid #aaa;">'.$otCGST_Rate.'</td>
					  <td style=" border: 1px solid #aaa;">'.$otCGST_Amt.'</td>
					  <td style=" border: 1px solid #aaa;">'.$otSGST_Rate.'</td>
					  <td style=" border: 1px solid #aaa;">'.$otSGST_Amt.'</td>
					  <td style=" border: 1px solid #aaa;">'.$otIGST_Rate.'</td>
					  <td style=" border: 1px solid #aaa;">'.$otIGST_Amt.'</td>
					  <td style=" border: 1px solid #aaa;">'.$TotalOtAmt.'</td>
				  </tr>';
			  }
			  ...
			  $Total = $TotalAmtOther + $tot_price;
					...
					<tr>
					  ...
					  <td colspan="8" align="right" style=" border: 1px solid #aaa;">'.$Total.'</td>
				  </tr>
					<tr>
					  <td colspan="4" align="right" style=" border: 1px solid #aaa;"><strong>Total Bill Value (In Words):</strong></td>
					  <td colspan="8" align="left" style=" border: 1px solid #aaa;">Rs. '.$custhelp->number_to_words($Total).'  Only</td>
				  </tr>	
				  <tr>
