...
$header = '<table width="100%">		
			<tr>
				<td colspan="2" style="border:none; padding:0;">
				   <img src="images/qthead.png" style="width:100% !important;"/>
				</td>			
			</tr>
		</table>';
...
<tr>
	...
	<table style="width: 100%;border:1px solid #aaa; table-layout:fixed; width:100%; border-collapse: collapse; ">
        <tr>
            <th height="35" style="border-right:1px solid #aaa;padding-left:5px;border-bottom:1px solid #aaa;" width="10px">S.No.</th>
            <th style="border-right:1px solid #aaa;padding-left:5px;border-bottom:1px solid #aaa;"width="150px">Material Description </th>
            <th style="border-right:1px solid #aaa;padding-left:5px;border-bottom:1px solid #aaa;"width="150px">Code Part/HSN Code</th>
            <th style="border-right:1px solid #aaa;padding-left:5px;border-bottom:1px solid #aaa;">QTY/MOQ</th>
			<th style="border-right:1px solid #aaa;padding-left:5px;border-bottom:1px solid #aaa;">Rate/Unit</th>
			<th style="border-right:1px solid #aaa;padding-left:5px;border-bottom:1px solid #aaa;">CGST Rate</th>
			<th style="border-right:1px solid #aaa;padding-left:5px;border-bottom:1px solid #aaa;">SGST Rate</th>
			<th style="border-bottom:1px solid #aaa;";>IGST Rate</th>
        </tr>';
	$i=1;	
	...
	if(count($quot->_itmes)  <= 6){			
		foreach($quot->_itmes as $item) {
			...
			$html2.='<tr><td height="30" align="center" width="10px" style="border-right:1px solid #aaa;border-bottom:1px solid #aaa;" >'.$i++.'</td>
				<td height="30" width="150px" style="border-right:1px solid #aaa;padding-left:5px;border-bottom:1px solid #aaa;" >'.$item->_item_descp.'</td>
				<td height="30" width="150px" style="border-right:1px solid #aaa;padding-left:5px;border-bottom:1px solid #aaa;" >'.$item->_item_code_part_no.'/'.$item->_hsn_code.'</td>
				...
				<td height="30" width="120px" style="border-right:1px solid #aaa;padding-left:5px;border-bottom:1px solid #aaa;" >'.$item->_price_per_unit.'/'.$item->_unit_name.'</td>
				<td height="30" width="80px" style="border-right:1px solid #aaa;padding-left:5px;border-bottom:1px solid #aaa;" >'.$item->_cgst_rate.'</td>
				<td height="30" width="80px" style="border-right:1px solid #aaa;padding-left:5px;border-bottom:1px solid #aaa;" >'.$item->_sgst_rate.'</td>
				<td height="30" width="80px" align="center" style="border-bottom:1px solid #aaa;">'.$item->_igst_rate.'</td>
			</tr>';
		}
		$html3.='</table>';
		...
		foreach($quot->_itmes as $item) {
			...
			$html2.='<tr><td height="30" align="center" width="10px" style="border-right:1px solid #aaa;border-bottom:1px solid #aaa;" >'.$i++.'</td>
				...
				<td height="30" width="150px" style="border-right:1px solid #aaa;padding-left:5px;border-bottom:1px solid #aaa;" >'.$item->_item_code_part_no.'/'.$item->_hsn_code.'</td>			
				<td height="30" align="center" style="border-right:1px solid #aaa;padding-left:5px;border-bottom:1px solid #aaa;">'.$item->_quantity.'</td>
				<td height="30" align="center" style="border-bottom:1px solid #aaa;">'.$item->_price_per_unit.'/'.$item->_unit_name.'</td>
				<td height="30" width="80px" style="border-right:1px solid #aaa;padding-left:5px;border-bottom:1px solid #aaa;" >'.$item->_cgst_rate.'</td>
				<td height="30" width="80px" style="border-right:1px solid #aaa;padding-left:5px;border-bottom:1px solid #aaa;" >'.$item->_sgst_rate.'</td>
				<td height="30" width="80px" align="center" style="border-bottom:1px solid #aaa;">'.$item->_igst_rate.'</td>
		...
		foreach($quot->_itmes as $item) {
			...
			$html2.='<tr><td height="30" align="center" width="10px" style="border-right:1px solid #aaa;border-bottom:1px solid #aaa;" >'.$i++.'</td>
				<td height="30" width="150px" style="border-right:1px solid #aaa;padding-left:5px;border-bottom:1px solid #aaa;" >'.$item->_item_descp.'</td>
				<td height="30" width="150px" style="border-right:1px solid #aaa;padding-left:5px;border-bottom:1px solid #aaa;" >'.$item->_item_code_part_no.'</td>			
				<td height="30" align="center" style="border-right:1px solid #aaa;padding-left:5px;border-bottom:1px solid #aaa;">'.$item->_quantity.'</td>
				<td height="30" align="center" style="border-bottom:1px solid #aaa;">'.$item->_price_per_unit.'/'.$item->_unit_name.'</td>
				<td height="30" width="80px" style="border-right:1px solid #aaa;padding-left:5px;border-bottom:1px solid #aaa;" >'.$item->_cgst_rate.'</td>
				<td height="30" width="80px" style="border-right:1px solid #aaa;padding-left:5px;border-bottom:1px solid #aaa;" >'.$item->_sgst_rate.'</td>
