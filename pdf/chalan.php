...
$header = '
<table width="100%" style="vertical-align: bottom; font-family: serif; font-size: 9pt;margin-bottom:5px;">
		<tr>
			
			<td colspan="2" align="left" style="font-size: 16pt; color: #000088;" align="center">CHALLAN</td>
		</tr>
		<tr>
			<td colspan="2">&nbsp;</td>			
		</tr>
		<tr>
			<td style="font-size: 9pt;border-left: 6px solid #5DADE2;padding-right:5px; font-color:black;padding-left: 8px;">
				<div class="row mb5">
				<div class="col-sm-8 address no-padding">
				  <p class="company-title" style="font-size: 12pt; border-bottom: 1px solid red;padding-bottom: 10px;">'.$CompanyInfo['Name'].'</p>
				  <address>'.wordwrap($CompanyInfo['Address'],70,'<br>').'</address>
				  
				  <p class="phone"><strong>Phones:</strong>'.$CompanyInfo['Phone'].'</p>
				  <p class="email"><strong>Email:</strong>'.$CompanyInfo['email'].'<strong>Web:</strong> '.$CompanyInfo['Website'].'</p>  
				</div>				
			  </div>
			</td>			
			<td style="font-size: 9pt; color: #000088; width:24%; padding-left:50px;"><img src="images/'.$imgname.'" height="85px;" width="90px;"/></td>	
		</tr>
