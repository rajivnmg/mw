...
function outInvExPDF($oinvoice_exciseID,$printType){
	...
	State & State Code : '.$billedState[0]->_stateName.' - '.$billedState[0]->tin_no.'  <br> Contact Name : '.$outgoing_invoice_excise_h->bname.' <br> Email : '.$outgoing_invoice_excise_h->bemailId.'</span> 
						 <br>
	...
	State & State Code : '.$shippedState[0]->_stateName.' - '.$shippedState[0]->tin_no.'<br> Contact Name : '.$outgoing_invoice_excise_h->bname.' <br> Email : '.$outgoing_invoice_excise_h->bemailId.'</span> 
						 <br>
			  ...
			  if(!empty(trim($decimalValue))){
				  $decimalValue = 'and '.$decimalValue.' Paise';
					...
					<tr>
					  ...
					  <td colspan="8" align="left" style=" border: 1px solid #aaa;">Rs. '.$custhelp->number_to_words($Total).''.$decimalValue.'  Only</td>
				  </tr>	
				  <tr>
