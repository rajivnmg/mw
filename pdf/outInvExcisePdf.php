...
include_once($root_path."Model/Masters/StateMaster_Model.php");
include_once($root_path."Model/Masters/CityMaster_Model.php");


function outInvExPDF($oinvoice_exciseID,$printType){
	$dir = 'pdf/invoices/';
	// define the seperate directory for generated invoice to save 
...
//	print_r($Print); die;
	...
	foreach($Print as $outgoing_invoice_excise_h){
		$filename = $outgoing_invoice_excise_h->oinvoice_No;
