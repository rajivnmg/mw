...
class Outgoing_Invoice_Excise_Model
{
   ...
   public static function GetLastInvoiceNumber(){
	        ...
	        if(MANESAR){
				 $exciseStr="M02-".$FinancialYear."%";
			}else if (GURGAON){
				$exciseStr="M01-".$FinancialYear."%";
			} else if (RUDRAPUR){
				$exciseStr="M03-".$FinancialYear."%";
			} else if (HARIDWAR){
				$exciseStr="M04-".$FinancialYear."%";
			} else{
	        ...
	        if($totExciseInvoiceNumber>0){
	           ...
	           return $getNewExciseInvoiceNo;
				...
				if(MANESAR){
					$exciseStr="M02-".$FinancialYear.$s;
				}else if (GURGAON){
					$exciseStr="M01-".$FinancialYear.$s;
				} else if (RUDRAPUR){
					$exciseStr="M03-".$FinancialYear.$s;
				} else if (HARIDWAR){
					$exciseStr="M04-".$FinancialYear.$s;
				} else{
