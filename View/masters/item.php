...
<div align="center" id="Form_Div" style="display: none;"><hidden id="item_id"></hidden>
      ...
      <div style="width:20%; float:left;">
        ...
        <div class="clr"></div> 
        <div>
			<input type="button" class="button" name="B5" value="Block" id="btnBlockitem"  onClick="BlockUnblockItem('Yes');"/>
            <input type="button" class="button" name="B4" value="Unblock" id="btnuUnblockitem"  onClick="BlockUnblockItem('No');"/>
			<input type="button" class="button" name="B" value="Save" id="btnadditem"  onClick="AddItemMaster();"/>
