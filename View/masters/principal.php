...
<div style="width:20%; float:left;"><label><span>Profit Margin(%) Rate</span></label></div>
<div style="width:29%; float:left;"><input type="text"  name="add" id="princ_margin" value="" placeholder="Profit Margin Rate" tabindex="12" ng-model="principal.PROFIT_MARGIN" required /> </div>
<div class="clr"></div>
