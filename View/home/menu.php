				...
				<ul class="dropdown-menu">';
						...
						if(checkPermission('excisestockval_View'))
						{
						 ...
						 if(checkPermission('excisestockstmt_view'))
						 {
							...
							echo '<li id="salsereport"><a href="'.SITE_URL.EX_STOCK_STMT.'">Stock Statement</a></li>';
							/* EOF to hide unused Reports by Ayush Giri on 14-07-2017 */
						 }
						...
						//~ echo '<li id="salsereport"><a href="'.SITE_URL.NONEX_STOCK_STMT.'">Non Excise Stock Statement</a></li>';
						 ...
						 //new report added on August 4,2018
						if(checkPermission('dailysalesreport_view'))
						{ 
						echo '<li id="salestallyreport"><a href="'.SITE_URL.STOCKLEVELREPORT.'">Stock Level Report</a></li>';
						}
			  echo'</ul>
			</li>';
		}            
    ...
    <li class="dropdown">
        ...
        <ul class="dropdown-menu dropdown-user">
          ...
          {  
           ...
           if(checkPermission('groupperm_add') && ($TYPE=='A' || $TYPE=='M'))
          {  
            echo '<li><a href="'.SITE_URL.UPDATEUSRPASSWORD.'">Update User Password</a></li>';
		  }
