...
<title>Outcoming Invoice With Excise Duty</title>
<style>
...
<div align="center">
    <h1>Outgoing Invoice Search/List<span></span></h1>
</div>
<div style="width:25%; float:left;">
<a class="button" href="<?php print SITE_URL.NEW_OUTGOING_INVOICE_EXCISE; ?>">New</a>
</div>
<div class="clr"></div>
<div>
...
<script type='text/javascript' src='../js/Business_action_js/view_Outgoing_Invoice_Excise.js'></script>
