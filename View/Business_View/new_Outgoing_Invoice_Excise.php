...
<style>
table.invoiceTbl tr td{ padding:4px;}
</style>
</head>
...
<div align="center"><h1>Outgoing Invoice Form</h1></div>
    <?php
     ...
     echo'<div style="width:33.3%; float:left;">
	  ...
	  echo'<input name="userType" type="hidden" id="userType" value="'.$_SESSION['USER_TYPE'].'" placeholder="Invoice Number"></input>';
...
-->
      ...
      <div style="width:33.3%; float:left;">
        <label>
            <span>LD/Docket No:</span>
            <input type="text" id="docket_no"  ng-model="outgoing_invoice_excise._docket_no" placeholder="LD/Docket No"></input>
...
-->
      ...
      <div style="width:100%; float:left; padding-bottom:15px; overflow:scroll; margin-bottom:10px;">
          <table class="invoiceTbl" width="100%" border="1" cellspacing="0" cellpadding="0" style=" min-width:1600px;">
            <tr>
              ...
              <td width="9%" rowspan="2"><label><span>Incoming Invoice No.</span></label>
              <div align="center" style="width:100%; float:left;">

                    <input name="allInvoice" type="checkbox" id="allInvoice" value="1" ng-click="showAllInvoice();" class="ng-pristine ng-valid">
                        <span style="font-weight: bold;">(All Invoice)</span>
      ...
      <!-- display from RG23D it means stock --></td>
              ...
              <td><!-- from po --><input type="text" style="width:50px;" id="oinv_price" ng-change="getTotal_Price();" ng-model="outgoing_invoice_excise.oinv_price"/></td>
            ...
            <tr  ng-repeat="item in outgoing_invoice_excise._items">
              <td><input type="text" style="width:50px;" ng-model="item.buyer_item_code" readonly/></td>
              <td><input type="text" name="oinv_codePartNo" id="oinv_codePartNo" ng-model="item.oinv_codePartNo" readonly/></td>
              <td><input type="text" style="width:50px;" ng-model="item.codePartNo_desc" readonly/>
      ...
      <div style="width:50%; float:left;">
          <div style="width:50%; float:left;">
            <label>
				...
				<hidden id="freight_gst_rate" ng-model="outgoing_invoice_excise.freight_gst_rate"></hidden>
            </label>
          </div>
          <div style="width:50%; float:left;">
            <label>
                <span>Freight Amount (F):</span>
                <input type="text" name="textfield10" id="txtfreight_amount" ng-change="BillCalculation();" ng-model="outgoing_invoice_excise.freight_amount" placeholder="Freight Amount" readonly></input>
				<hidden id="freight_gst_amount" ng-model="outgoing_invoice_excise.freight_gst_amount"></hidden>
            </label>
          </div>
          <div class="clr"></div>
      </div>
      ...
      <div style="width:50%; float:left;">
          <div style="width:50%; float:left;">
            <label>
                ...
                <input name="textfield5" type="text" id="txtpf_charg" ng-change="BillCalculation();" ng-model="outgoing_invoice_excise.pf_chrg" placeholder="P & F Charge" readonly></input>
                <hidden id="txtpf_charg_percent" ng-model="outgoing_invoice_excise.pf_chrg_percent"></hidden>
				<hidden id="p_f_gst_rate"   ng-model="outgoing_invoice_excise.p_f_gst_rate"></hidden>
				<hidden id="p_f_gst_amount" ng-model="outgoing_invoice_excise.p_f_gst_amount"></hidden>
                <!-- sum of ED Amt. -->
            </label>
          </div>
          <div style="width:50%; float:left;">
            <label>
                ...
                <input name="textfield6" type="text" id="txtincidental_chrg" ng-change="BillCalculation();" ng-model="outgoing_invoice_excise.incidental_chrg" placeholder="Incidental Charges" readonly></input>
                <hidden id="txtincidental_chrg_percent" ng-model="outgoing_invoice_excise.incidental_chrg_percent"></hidden>
				<hidden id="inc_gst_rate"   ng-model="outgoing_invoice_excise.inc_gst_rate"></hidden>
				<hidden id="inc_gst_amount" ng-model="outgoing_invoice_excise.inc_gst_amount"></hidden>
            </label>
          </div>
          <div class="clr"></div>
      </div>
      ...
      <div style="width:50%; float:left;">
          <div style="width:50%; float:left;">
            <label>
                ...
                <input type="text" name="ins_charge"   id="ins_charge" is-number ng-change="BillCalculation();" ng-model="outgoing_invoice_excise.ins_charge"  tabindex="39"  readonly/>
                <hidden id="ins_gst_rate"   ng-model="outgoing_invoice_excise.ins_gst_rate"></hidden>
				<hidden id="ins_gst_amount" ng-model="outgoing_invoice_excise.ins_gst_amount"></hidden>
            </label>
          </div>
          <div style="width:50%; float:left;">
            <label>
                <span>Other Charges(%):</span>
                <input type="text" name="othc_charge" id="othc_charge" is-number ng-change="BillCalculation();" ng-model="outgoing_invoice_excise.othc_charge"  tabindex="40" readonly/>
                <hidden id="othc_gst_rate"   ng-model="outgoing_invoice_excise.othc_gst_rate"></hidden>
				<hidden id="othc_gst_amount" ng-model="outgoing_invoice_excise.othc_gst_amount"></hidden>
            </label>
          </div>
	  </div>
	  <div class="clr"></div>
      <div style="width:50%; float:left;">
       ...
       <div  style="width:30%; float:left;">
                <label>
                    <span>Buyer Name (Order confirmation will be received here):</span>
					   <input type="text" name="bname" id="bname" ng-model="outgoing_invoice_excise.bname" tabindex="45" class="input1" required readonly/>
	  ...
	  <div id="bmail" style="width:30%; float:left;">
                <label>
                    <span>Buyer Email (Dispatch Information will be received here):</span>
					   <input type="text" name="bemailId" id="bemailId" ng-model="outgoing_invoice_excise.bemailId" tabindex="45" class="input1" required readonly/>
