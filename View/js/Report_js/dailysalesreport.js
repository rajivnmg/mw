...
function LoadDailySalesReport() {
    ...
    $(".dailysalesreport").flexigrid({
		...
		{ display: 'CGST Components', name: 'cgst_camt', width: 100, sortable: false, align: 'left'},
		{ display: 'SGST Components', name: 'sgst_camt', width: 100, sortable: false, align: 'left'},
		{ display: 'IGST Components', name: 'igst_camt', width: 100, sortable: false, align: 'left'},
