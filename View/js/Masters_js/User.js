...
/* var SitePath = "http://78.47.138.85/gurgaon/View/home/Dashboard.php";
var AdminHomePath = "http://78.47.138.85/gurgaon/View/home/AdminHome.php"; */
/* var SitePath = "http://192.168.1.121/multiGurgaonNew/View/home/Dashboard.php";
var AdminHomePath = "http://192.168.1.121/multiGurgaonNew/View/home/AdminHome.php";
var SalesExecutiveHomePath="http://192.168.1.121/multiGurgaonNew/View/SalesExecutive/Dashboard.php";
var ManagementHomePath="http://192.168.1.121/multiGurgaonNew/View/Management/Dashboard.php";
*/
...
// Update user password by admin added on July 7th, 2018
var UpdateUserPassword_app = angular.module('UpdateUserPassword_app', []);
UpdateUserPassword_app.controller('UpdateUserPassword_Controller', function ($scope) {
    $scope.submitForm = function () {
		
        if ($scope.UpdatePassword.newpass == $scope.UpdatePassword.confirmpass) {
            var json_string = JSON.stringify($scope.UpdatePassword);
            jQuery.ajax({
                url: "../../Controller/Master_Controller/User_Controller.php",
                type: "POST",
                data: { TYP: "UPDATE", ACTION: "UpdateUserPassword", UpdatePassword: json_string },
                success: function (jsondata) {
                    //alert(jsondata);
                    var objs = jQuery.parseJSON(jsondata);
                    if (objs=="YES") {
