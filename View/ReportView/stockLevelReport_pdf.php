...
class PDF extends FPDF
{
    ...
    { 
        ...
        { //width
            ...
            $this->Cell(80,6,wordwrap($eachResult["Item_Desc"],3,"\n"),0);
            $this->Cell(25,6,$eachResult["Tarrif_Heading"],0);
            $this->Cell(15,6,$eachResult["Lsc"],0);
            $this->Cell(15,6,$eachResult["Usc"],0);
...
$header=array('SNo','PartNo','Product Description','HSN Code','LSC','USC','Quantity','Unit');
//Data loading
//*** Load MySQL Data ***//
...
$pdf->Cell(55);
$pdf->Write(5, 'Stock Level Report');
$pdf->Ln();

$pdf->SetFillColor(255,255,255);
$w=array(10,20,80,25,15,15,15,15);
