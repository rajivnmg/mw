    ...
    { 
        ...
        { //width
			...
			if($eachResult['other_amt'] !== "Total : "){
				...
				$this->Cell(13,6,number_format((float)$cgst_famt, 2, '.', ''),0);
				$this->Cell(13,6,number_format((float)$igst_famt, 2, '.', ''),0);
				$this->Cell(13,6,number_format((float)$igst_famt, 2, '.', ''),0);
...
$header=array('SN','Invoice No','Invoice Date','Principal Name','BuyerName','Taxable Amt','CGST Amt','SGST Amt','IGST Amt','Fre. Amt','P&F Amt','Ins. Amt','Inc. Amt','Oth. Amt','CGST Comp','SGST Comp','IGST Comp','Total Amt');
//Data loading
//*** Load MySQL Data ***//
...
$w=array(6,26,20,25,25,20,17,17,17,17,17,17,17,17,17,13,13,13,17);
