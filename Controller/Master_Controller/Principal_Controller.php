...
switch($Type){
    case QueryModel::INSERT:
      ...
      $USERID=$_SESSION["USER"];
		...
		$PRINCIPAL_SUPPLIER_ID = Principal_Supplier_Master_Model::Insert_Principal_Supplier($Principal_Supplier_Name, $ADD1, $ADD2, $CITYID, $STATEID, $PINCODE, $PS_RANGE,$PS_DIVISION,$PS_COMMISSIONERATE, $ECC_CODENO, $TINNO, $PANNO, $TYPE, $TAX_TYPE,$USERID,$PROFIT_MARGIN);
    ...
    case QueryModel::UPDATE:
		...
		$Result = Principal_Supplier_Master_Model::Update_Principal_Supplier($obj->{'_principal_supplier_id'},$obj->{'_principal_supplier_name'},$obj->{'_add1'}, $obj->{'_add2'}, $obj->{'_pincode'}, $obj->{'_pc_range'},$obj->{'_pc_division'},$obj->{'_commission_rate'}, $obj->{'_ecc_codeno'}, $obj->{'_tin_no'}, $obj->{'_pan_no'}, $obj->{'_city_id'}, $obj->{'_state_id'}, $obj->{'_tax_type'},$obj->{'PROFIT_MARGIN'});
