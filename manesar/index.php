...
if(isset($_SESSION['SITENAME']) && $_SESSION['SITENAME']=='MANESAR'){  //  check the sitename in session 
...
header("Location:".$_SESSION['SITE_URLS']);
 exit;
	...
	echo '<script type="text/javascript">alert("You are already logged into '. $_SESSION['SITENAME'].' instance. Please logout then you can use MANESAR instance.");</script>';
}
 exit;
