...
*/
if(isset($_SESSION['SITENAME']) && $_SESSION['SITENAME']=='GURGAON'){ //  check the sitename in session 
	...
	echo '<script type="text/javascript">alert("You are already logged into '. $_SESSION['SITENAME'].' instance. Please logout then you can use GURGAON instance.");</script>';
}
 exit;
